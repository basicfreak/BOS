...
void _API_init()
{
	API_SymTbl_Base = (uint32_t) calloc(0x8000);
	...
	_API_Add_Symbol("malloc", (uint32_t)&malloc);
	_API_Add_Symbol("calloc", (uint32_t)&calloc);
	_API_Add_Symbol("_VMM_map", (uint32_t)&_VMM_map);
	_API_Add_Symbol("_VMM_unmap", (uint32_t)&_VMM_unmap);
	_API_Add_Symbol("free", (uint32_t)&free);
	...
	_API_Add_Symbol("memsetl", (uint32_t)&memsetl);
	_API_Add_Symbol("Load_ELF", (uint32_t)&Load_ELF);
	_API_Add_Symbol("Load_Mod", (uint32_t)&Load_Mod);
}
