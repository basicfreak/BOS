#ifndef				I686_H_INCLUDED
	#define				I686_H_INCLUDED

	#include <KLIB.h>

	extern void _GDT_Load(void);
	extern void _GDT_SwitchSegmentKernel(void);
	extern void _GDT_SwitchSegmentUser(void);

	extern void _TSS_setESP(void);
	extern void _TSS_Flush(void);

	extern void _SSE_init(void);
	extern void _FPU_init(void);
	extern void SSE_Save(void*);
	extern void SSE_Load(void*);

	extern void _IDT_Load(void);

	extern void _PIC_init(void);

	void _i686_init(void);
	void _IDT_init(void);
